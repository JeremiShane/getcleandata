...
getclean <- function(datadir=getwd(), writedir=getwd()){
        ...
        vDescriptiveMeanStdFeatures <- gsub("X","\\.x",vDescriptiveMeanStdFeatures)
        vDescriptiveMeanStdFeatures <- gsub("Y","\\.y",vDescriptiveMeanStdFeatures)
        vDescriptiveMeanStdFeatures <- gsub("Z","\\.z",vDescriptiveMeanStdFeatures)
